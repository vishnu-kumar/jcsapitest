...
AWSGroup = [
    ...
    cfg.StrOpt('subnet_id',
                default=None,
                help='default subnet_id in which instances need to be run.'),
     cfg.StrOpt('vpc_id',
                default=None,
                help='default vpc_id in which instances need to be run.'),
]
...
class ConfigPrivate(object):
    ...
    def __init__(self, parse_conf=True):
        ...
        cfg.CONF([], project='jcsapi', default_config_files=config_files)
	std_logging.basicConfig()
        LOG = logging.getLogger('jcsapi')
        LOG.info("Using jcsapi config file %s" % path)
        register_opts()
